...
async function getCompletedAuction(ctx: GenericMutationCtx<DataModel>, roomId: Id<"rooms">): Promise<AuctionWithGuest> {
...
async function ensureMatch(ctx: GenericMutationCtx<DataModel>, auction: AuctionWithGuest, roomId: Id<"rooms">) {
