export const en = {
  ...
  profile: {
    ...
    username: 'Username',
    bio: 'Bio',
    bioPlaceholder: 'Tactical manager bio...',
    ...
    noMatches: 'No matches recorded yet. Play a match to build your history!',
    joinedDate: 'Joined',
  ...
  friends: {
    ...
    noSearchResults: 'No players found with that username.',
  ...
  leagues: {
    ...
    publicLeagues: 'Public Discovery',
    createLeague: 'Create League',
    joinWithCode: 'Join with Code',
    enterCode: 'Enter 8-character invite code...',
    join: 'Join League',
    create: 'Create New League',
    leagueName: 'League Name',
    description: 'Description (Optional)',
    gameScope: 'Game Scope',
    allGames: 'Combined (Snipe & Rank)',
    snipeOnly: 'Snipe Auctions Only',
    rankOnly: 'Rank Duels Only',
    kind: 'League Privacy',
    ...
    members: 'Members',
    matches: 'Match Log',
    playMatch: 'Play League Match',
    playSnipe: 'Play Snipe Auction',
    playRank: 'Play Rank Duel',
    rank: 'Pos',
    manager: 'Manager',
    pts: 'PTS',
    gd: 'GD',
    ...
    fullLeague: 'League Full (50/50)',
    noLeagues: 'You have not joined any leagues yet.',
    noPublicLeagues: 'No public leagues available right now.',
    maxCapNote: 'Public leagues are capped at 50 managers.',
  },
} as const;
