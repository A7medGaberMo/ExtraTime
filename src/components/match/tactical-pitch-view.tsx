  ...
  return (
    <div className="space-y-3">
      <div className="inline-flex w-full rounded-lg border border-white/5 bg-slate-950 p-1">
        <button
          onClick={() => setTab("host")}
          className={`flex-1 rounded-md py-2 text-[10px] font-black uppercase tracking-wider transition-all duration-200 ${
      ...
      <TacticalPitch
        ...
        matchSize={matchSize}
        squad={toSlots(squad)}
        totalRounds={formation === "1-2-1" || formation === "2-1-1" || formation === "1-1-2" ? 5 : 11}
