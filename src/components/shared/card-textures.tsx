      ...
      return (
        <svg className="absolute inset-0 w-full h-full opacity-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
          <pattern id="tex-icon-marble" width="100" height="100" patternUnits="userSpaceOnUse">
            <path d="M 0 20 Q 25 5, 50 40 T 100 20 M 100 70 Q 75 95, 25 70 T 0 100" fill="none" stroke="#F7F5EF" strokeWidth="0.8" />
            <path d="M 15 0 Q 35 35, 75 15 T 100 75" fill="none" stroke="#D4AF37" strokeWidth="0.6" />
            <text x="50" y="55" fontSize="8" fontFamily="sans-serif" fontWeight="900" fill="#D4AF37" opacity="0.3" textAnchor="middle">ET</text>
          </pattern>
      ...
      return (
        <svg className="absolute inset-0 w-full h-full opacity-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
          <pattern id="tex-master-crystal" width="40" height="40" patternUnits="userSpaceOnUse">
            <polygon points="20,0 40,10 40,30 20,40 0,30 0,10" fill="none" stroke="#D8B4FE" strokeWidth="0.6" />
      ...
      return (
        <svg className="absolute inset-0 w-full h-full opacity-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
          <pattern id="tex-elite-poly" width="30" height="30" patternUnits="userSpaceOnUse">
            <path d="M 0 0 L 30 15 L 0 30 Z M 30 0 L 30 30 L 0 15 Z" fill="none" stroke="#93C5FD" strokeWidth="0.5" />
          </pattern>
      ...
      return (
        <svg className="absolute inset-0 w-full h-full opacity-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
          <pattern id="tex-gold-engrave" width="50" height="50" patternUnits="userSpaceOnUse">
            <circle cx="25" cy="25" r="20" fill="none" stroke="#FDE68A" strokeWidth="0.5" strokeDasharray="2,2" />
